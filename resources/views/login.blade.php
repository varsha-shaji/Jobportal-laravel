        ...
        <div class="image1">
            <img src="images/Mobile-login.jpg" alt="">
                    ...
                    <div class="popup">
                        ...
                        <form method="POST" action="/login" id="login" class="logform">
    @csrf
                            <table width="500px" height="350px" >
                            <tr>
                                    <td colspan="2"><input type="text" name="loginname" id="name" class="btns" placeholder="Username/name" required/>
                                  </td>
                                </tr>
                                <tr>
                                    <td colspan="2"><input type="password" name="loginpassword" id="pas" class="btns" placeholder="Password" required/>
                                     </tr>
                                <tr>
                                    <td colspan="2"><input type="submit" name="submit" class="sub" id="sub" value="Login"/></td>
                                </tr>
                                <tr>
                                    <td><button class="button" id="regi"><a href="/registerpage">New User?Click here to register.</a></button></td></tr>
                            </table>
                        </form>
